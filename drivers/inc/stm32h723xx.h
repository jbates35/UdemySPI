...
#define TIM15 ((GenTimer_RegDef_t *)TIM15_BASEADDR)
#define TIM16 ((GenTimer_RegDef_t *)TIM16_BASEADDR)
...
typedef enum { ADC_LTR1 = 0 } ADC_LTR1_BIT;

typedef enum { ADC_HTR1 = 0 } ADC_HTR1_BIT;
...
typedef enum { ADC_TR2_LT2 = 0, ADC_TR2_HT2 = 16 } ADC_TR2_BIT;
...
typedef enum {
  ADC_OFR1_OFFSETY = 0,
  ADC_OFR1_OFFSETY_CH = 26,
  ADC_OFR1_SSATE = 31
} ADC_OFR1_BIT;

typedef enum {
  ADC_OFR2_OFFSETY = 0,
  ADC_OFR2_OFFSETY_CH = 26,
  ADC_OFR2_SSATE = 31
} ADC_OFR2_BIT;

typedef enum {
  ADC_OFR3_OFFSETY = 0,
  ADC_OFR3_OFFSETY_CH = 26,
  ADC_OFR3_SSATE = 31
} ADC_OFR3_BIT;

typedef enum {
  ADC_OFR4_OFFSETY = 0,
  ADC_OFR4_OFFSETY_CH = 26,
  ADC_OFR4_SSATE = 31
} ADC_OFR4_BIT;

typedef enum { ADC_JDR = 0 } ADC_JDR_BIT;
typedef enum { ADC_JDR1 = 0 } ADC_JDR1_BIT;
typedef enum { ADC_JDR2 = 0 } ADC_JDR2_BIT;
typedef enum { ADC_JDR3 = 0 } ADC_JDR3_BIT;
typedef enum { ADC_JDR4 = 0 } ADC_JDR4_BIT;

typedef enum { ADC_AWD2CR_AWD2CH = 0 } ADC_AWD2CR_BIT;
typedef enum { ADC_AWD3CR_AWD3CH = 0 } ADC_AWD3CR_BIT;

typedef enum { ADC_LTR2 = 0 } ADC_LTR2_BIT;
typedef enum { ADC_HTR2 = 0 } ADC_HTR2_BIT;
typedef enum { ADC_LTR3 = 0 } ADC_LTR3_BIT;
typedef enum { ADC_HTR3 = 0 } ADC_HTR3_BIT;

typedef enum { ADC_DIFSEL = 0 } ADC_DIFSEL_BIT;
typedef enum { ADC_CALFACT_S = 0, ADC_CALFACT_D = 16 } ADC_CALFACT_BIT;
typedef enum { ADC_CALFACT2_LINCALFACT = 0 } ADC_CALFACT2_BIT;
...
typedef enum { ADC_CDR1_RDATA_MST = 0, ADC_CDR1_RDATA_SLV = 16 } ADC_CDR_BIT;
typedef enum { ADC_CDR2_RDATA_MST = 0, ADC_CDR2_RDATA_SLV = 16 } ADC_CDR2_BIT;
